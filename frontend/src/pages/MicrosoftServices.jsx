...
export default function MicrosoftServices() {
  return (
    <div data-testid="ms-services-page" className="bg-paper">
      <section className="relative overflow-hidden bg-ink py-16 text-paper grain lg:py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
          <MaskedLine delay={0.1}>
            <span className="eyebrow !text-brand">Microsoft Solutions</span>
          </MaskedLine>
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/15 px-6 py-3.5 text-sm font-semibold text-paper/80 transition-colors duration-200 hover:border-brand hover:text-brand"
            >
              <Phone size={14} /> {MS_CONTACT.phone}
            </a>
          </motion.div>
          <Reveal delay={0.65}>
            <p className="mt-6 text-xs text-paper/40" data-testid="ms-hero-contact">
              Microsoft services enquiries: <span className="font-semibold text-paper/70">{MS_CONTACT.name}</span> · {MS_CONTACT.phone} · {MS_CONTACT.email}
            </p>
          </Reveal>
        </div>
      </section>
            ...
            <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {group.services.map((s, i) => (
                ...
                >
                  ...
                  >
                    <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-subtle text-brand transition-colors duration-300 group-hover:bg-brand group-hover:text-white">
                      <s.icon size={19} />
                    </span>
                    ...
                    <Link
                      ...
                      className="mt-4 inline-flex w-fit items-center gap-1 text-xs font-semibold text-brand transition-colors duration-200 hover:text-brand-hover"
                    >
      ...
      <section className="relative overflow-hidden bg-ink py-16 text-paper grain lg:py-20" data-testid="ms-closing-cta">
